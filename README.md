...
| # | Topic | Concepts | Date |
|---|-------|----------|------|
| 01 | [Two Networks, One Router](01-two-networks-one-router/README.md) | Routing, default gateway, DHCP, subnetting | 08/2026 |
| 02 | [Three Networks, Two Routers](02-three-networks-two-routers/README.md) | Static routing, multiple routers, DHCP | 08/2026 |
| 03 | [Branch and Headquarters](03-interconnection-of-branch-with-central-server/README.md) | Inter site communication, static routing, DHCP, client/server | 08/2026 |
| 04 | [DNS Server](04-dns-server/README.md) | DNS resolution, A record, static IP, HTTP service | 08/2026 |
| 05 | [Subnetting, DNS and Web Server](05-subnetting-dns-and-web-server/README.md) | Subnetting (VLSM), static IP, DNS, HTTP/Web service | 08/2026 |
| 06 | [VLANs with Router on a Stick](06-vlan-router-on-a-stick/README.md) | VLAN, trunk, subinterfaces, dot1Q encapsulation | 08/2026 |
| 07 | [TechNova Solutions](07-technova-solutions/README.md) | VLAN, subnetting, branch and HQ, inter-site communication, DHCP | 08/2026 |
